...
5. Use `scripts/fetch_openapi.py` when a local sync or drift check is needed, and
   `scripts/list_sdks.py` to list the SDKs the docs index currently advertises.
